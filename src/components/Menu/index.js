    ...
    return <Container>
      {
        !this.state.showOptions
          ? <i aria-hidden="true" className="icon material-icons" onClick={this.showOptionsHandler}>more_vert</i>
          : <i aria-hidden="true" className="icon material-icons" onClick={this.closeOptionsHandler}>close</i>
      }
